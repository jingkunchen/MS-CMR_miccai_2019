...
for pp in range(start_number, end_number):
    ...
    for image in gt_array:
        ...
        image = resize(image,new_shape_1, preserve_range =True)
        image1 = resize(image1,new_shape_1, preserve_range =True)
        image2 = resize(image2,new_shape_1, preserve_range =True)
...
train_imgs_new  = LGE_data_1ch.copy()
train_masks_new  = T2_gt_1ch.copy()
count_i = 0
count = 0
count_list = []
for image in T2_gt_1ch:
    ...
    count_i +=1
LGE_data_1ch = train_imgs_new
T2_gt_1ch = train_masks_new
